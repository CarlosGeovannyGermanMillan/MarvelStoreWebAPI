...
using TiendaMarvel.Models.ManageViewModels;
...
namespace TiendaMarvel.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            //UserInSystemViewModel
            var users = _userManager.Users
                        .Select( u => u);
            
            var model = new List<UserInSystemViewModel>();
            foreach(var u in users){
                var roles = await _userManager.GetRolesAsync(u);

                model.Add(new UserInSystemViewModel (){
                            UserName = u.UserName,
                            Email = u.Email,
        ...
        public async Task<IActionResult> Roles(string id){
            ...
            model.RolesDisponibles.Add("Admin");
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("TiendaMarvel"),
